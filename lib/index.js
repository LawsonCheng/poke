...
class PokeClass extends Event_1.EventManagerClass {
    ...
    constructor(host, options, callback) {
        ...
        this.promise = () => new Promise((resolve, reject) => {
            this.makeRequest(result => {
                !(0, PokeResult_1.isPokeError)(result) ? resolve(result) : reject(result);
            });
        });
        /**
    ...
    makeRequest(requestCallback) {
        ...
        // append query string
        path = `/${path}${Object.keys(((_b = this.options) === null || _b === void 0 ? void 0 : _b.query) || {}).length > 0 ? (0, Query_1.stringifyQuery)(((_c = this.options) === null || _c === void 0 ? void 0 : _c.query) || {}) : ''}`;
        ...
        const result = {
            ...
            json: (jsonCallback) => jsonCallback
                ? (0, JSON_1.toJsonWithCallback)(result.body, jsonCallback)
                : (0, JSON_1.toJson)(result.body)
        };
